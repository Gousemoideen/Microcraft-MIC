    ...
    <header className="sticky top-0 z-40 border-b bg-background/90 backdrop-blur">
      ...
      <div className="mx-auto flex h-16 w-full items-center justify-between px-4 sm:px-6">
        ...
        <nav className="flex items-center gap-2">
          ...
          <Link href="/certificates" className={cn("hidden rounded-md px-3 py-2 text-sm font-medium hover:bg-accent sm:inline-flex")}>
            Certificates
          </Link>
      ...
      {isMobileMenuOpen && (
        <div className="sm:hidden absolute top-16 left-0 right-0 border-b border-white/10 bg-[#0a0a0f] p-4 shadow-xl flex flex-col gap-2">
          ...
          <Link href="/certificates" className="rounded-md px-3 py-3 text-sm font-medium hover:bg-white/10 border-b border-white/5" onClick={closeMenu}>
            Certificates
          </Link>
